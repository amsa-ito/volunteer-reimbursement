...
<fieldset>
    ...
    <div class="form-row">
        ...
        <div class="rv-form-group">
            ...
            <input type="email" name="additional_email" id="additional_email" value="<?php echo esc_attr($form_data['additional_email'] ?? ''); ?>" data-helper="A copy of the reimbursement will be CC'ed to this email address once processed">
        </div>
    </div>
</fieldset>
